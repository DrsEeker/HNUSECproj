...
BEGIN_MESSAGE_MAP(CMicrophoneControllerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMicrophoneControllerApp 构造

CMicrophoneControllerApp::CMicrophoneControllerApp()
{
	// 支持重新启动管理器
...
// 唯一的 CMicrophoneControllerApp 对象

CMicrophoneControllerApp theApp;


// CMicrophoneControllerApp 初始化
